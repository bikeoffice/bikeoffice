        ...
        <section aria-label="Settings">
            ...
            <article>
                ...
                <div>
                    ...
                    <form>
                        ...
                        <label htmlFor="password">Repetir Contraseña</label><br/>
            ...
            <article>
                ...
                <div>
                    ...
                    <div>
                        <label htmlFor="city">Localidad</label><br/>
            ...
            <article>
                ...
                <div>
                    <div>
                        <div></div>
                        <input type="text" id="primary" /><br/>
                        <label htmlFor="primary">Color Primario</label>
                    </div>
                    <div>
                        <div></div>
                        <input type="text" id="secondary-color" /><br/>
                        <label htmlFor="secondary-color">Color Secundario</label>
                    </div>
                    <div>
                        <div></div>
                        <input type="text" id="terciary-color" /><br/>
                        <label htmlFor="terciary-color">Color Terciario</label>
                    </div>
                    <div>
                        <div></div>
                        <input type="text" id="alert-color" /><br/>
                        <label htmlFor="alert-color">Color Alert</label>
                    </div>
                    <div>
                        <div></div>
                        <input type="text" id="text-hover-color" /><br/>
