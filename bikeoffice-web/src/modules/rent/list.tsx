...
export const RentList = props => {
	return (
		<List {...props} filters={<RentFilter />} perPage={10}>
			<Datagrid rowClick="edit">
				<ReferenceField label="Client" source="clientId" reference="clients">
					<TextField source="name" />
				</ReferenceField>
				<ReferenceField label="Bike" source="bikeId" reference="bikes">
					<TextField source="name" />
				</ReferenceField>
...
const RentFilter = props => (
	<Filter {...props}>
		<ReferenceInput source="clientId" label="Client" reference="clients">
			<SelectInput optionText="name" />
		</ReferenceInput>
		<ReferenceInput source="bikeId" label="Bike" reference="bikes">
			<SelectInput optionText="name" />
		</ReferenceInput>
