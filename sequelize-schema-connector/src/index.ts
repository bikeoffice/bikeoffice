...
interface Actions<Attributes extends { id: string | number }, CreationAttributes extends object = Attributes> {
	getOne: (identifier: Attributes["id"], opts?: { req: any; res: any }) => Promise<Model<Attributes, CreationAttributes> | null>;
	create: (body: CreationAttributes, opts?: { req: any; res: any }) => Promise<Model<Attributes, CreationAttributes>>;
	destroy: (id: Attributes["id"], opts?: { req: any; res: any }) => Promise<{ id: Attributes["id"] }>;
	update: (id: Attributes["id"], data: Partial<Attributes>, opts?: { req: any; res: any }) => Promise<Model<Attributes, CreationAttributes>>;
	getList: (
		conf: {
...
const sequelizeSchemaCrud = <Attributes extends { id: string | number }, CreationAttributes extends object = Attributes>(
